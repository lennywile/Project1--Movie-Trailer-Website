##############################################################################################################################
#																															 #
#		mymovies.py:    Glen Wile																							 #
#						03/01/2015																							 #
#		Ths code instantiates the Movies class, which is defined in media.py.  There are 6 different movies, all of which    #
#       are classics.  After the instances are created, they are added to an array, which is passed to the open_movies_page  #
#		method that is provided to us and is defined in fresh_tomatoes.py.  This function renders the web page with our six  #
...
animal_house = media.Movie("Animal House",
						   "An educational classic of Greek college living in the 1960's",
...
stripes = media.Movie("Stripes","Why everyone should join the US Army",
...
godfather = media.Movie("The GodFather","New York crime family entertainment at its best",
							 "http://upload.wikimedia.org/wikipedia/en/thumb/1/1c/Godfather_ver1.jpg/220px-Godfather_ver1.jpg",
							 "https://www.youtube.com/watch?v=sY1S34973zA")


rudy = media.Movie("Rudy","How to make money by being bad at football",
							 "http://upload.wikimedia.org/wikipedia/en/2/29/Rudy2.jpg",
							 "https://www.youtube.com/watch?v=eDKOlH0I0nQ")


hoosiers = media.Movie("Hoosiers","An early version of the Spurs",
