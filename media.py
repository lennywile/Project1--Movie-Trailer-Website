...
#		media.py:      Lenny Wile																							 #
#						03/01/2015																							 #
#		Ths code defines the Movie class that is used by mymovies.py (where this class is instantiated).                     # 
...
#																															 #
#		open - a function of hte webbrowser standard class, this will open the trailer, given a link to the trailer,  	 	 #
#              and play the trailer when the poster is clicked on the webpage display 										 #
#																															 #
##############################################################################################################################
